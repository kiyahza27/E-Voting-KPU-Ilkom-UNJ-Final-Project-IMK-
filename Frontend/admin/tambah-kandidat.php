				...
				<div class="container-fluid">
					<div class="card card-dark">
						<div class="card-header">
							<h3 class="card-title">
							<i class="fa fa-table"></i> Tambah Data Kandidat </h3>
						</div>
						...
						<form action="" method="post" enctype="multipart/form-data">
							<div class="card-body">
								...
								<div class="form-group row">
									<label class="col-sm-2 col-form-label">Jenis Kandidat</label>
									<div class="col-sm-6">
										<select name="kandidat" id="kandidat" class="form-control">
											<option>- Pilih -</option>
											<option>BEM Universitas</option>
											<option>BEM Fakultas</option>
											<option>BEM Prodi</option>
										</select>
									</div>
								</div>
							...
							<div class="card-footer">
								...
								<a href="data-kandidat.php" title="Kembali" class="btn btn-secondary">Batal</a>
							</div>
						</form>
					</div>
				</div>
